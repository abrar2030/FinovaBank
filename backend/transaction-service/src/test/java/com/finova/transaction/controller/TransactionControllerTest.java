...
import com.finova.transaction.controller.TransactionController; // Corrected import
import com.finova.transaction.model.Transaction; // Assuming model exists and has necessary fields/methods
import com.finova.transaction.service.TransactionService; // Corrected import
...
import java.time.LocalDateTime; // Assuming Transaction uses LocalDateTime
...
@WebMvcTest(TransactionController.class) // Uncommented and corrected class
public class TransactionControllerTest {
    ...
    public void testGetAllTransactions() throws Exception {
        // Arrange
        Transaction tx1 = new Transaction(); tx1.setId(1L); tx1.setDescription("Coffee"); tx1.setAmount(-50.0);
        Transaction tx2 = new Transaction(); tx2.setId(2L); tx2.setDescription("Salary"); tx2.setAmount(2000.0);
