...
describe('RegisterScreen (Mobile)', () => {
  ...
  test('allows inputting registration details', () => {
    ...
    fireEvent.changeText(
      screen.getByLabelText('Confirm Password Input'),
      'pass123',
    );

    expect(screen.getByLabelText('Username Input').props.value).toBe(
      'newmobile',
    );
    expect(screen.getByLabelText('Email Input').props.value).toBe(
      'new@mobile.com',
    );
    expect(screen.getByLabelText('Password Input').props.value).toBe('pass123');
    expect(screen.getByLabelText('Confirm Password Input').props.value).toBe(
      'pass123',
    );
  });
