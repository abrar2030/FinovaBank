...
// /home/ubuntu/finova_project/web-frontend/src/pages/Register.tsx
// Adjust the import path if necessary.
// import Register from '../../../../finova_project/web-frontend/src/pages/Register';
...
describe('Register Page', () => {
    ...
    test('calls register handler on button click if passwords match', () => {
        ...
        expect(consoleSpyLog).toHaveBeenCalledWith('Registering user:', 'newuser', 'newuser@example.com');
