...
// /home/ubuntu/finova_project/web-frontend/src/pages/Loans.tsx
// Adjust the import path if necessary.
// import Loans from '../../../../finova_project/web-frontend/src/pages/Loans';
...
describe('Loans Page', () => {
    test('renders loan information table when loans exist', () => {
        ...
        // Check for headers
        expect(screen.getByRole('columnheader', { name: /Loan ID/i })).toBeInTheDocument();
        expect(screen.getByRole('columnheader', { name: /Type/i })).toBeInTheDocument();
        expect(screen.getByRole('columnheader', { name: /Amount/i })).toBeInTheDocument();
        expect(screen.getByRole('columnheader', { name: /Status/i })).toBeInTheDocument();
        expect(screen.getByRole('columnheader', { name: /Next Payment/i })).toBeInTheDocument();

        // Check for loan data
        expect(screen.getByRole('cell', { name: 'L001' })).toBeInTheDocument();
        expect(screen.getByRole('cell', { name: 'Personal Loan' })).toBeInTheDocument();
        ...
        expect(screen.getByRole('cell', { name: '2025-06-01' })).toBeInTheDocument();
